 ...
 * 
 * Example:
 * 			!dumpmoduleexports 0x00000130550DA7C8 
 * Example output: 
...
public class DumpModuleExportsCommand extends Command
{
	...
	{
		addCommand("dumpmoduleexports", "<packageAddress>", "dump all modules that the package is exported to");
	}
	
	public void run(String command, String[] args, Context context, PrintStream out) throws DDRInteractiveCommandException 
	{
		if (args.length != 1) {
			CommandUtils.dbgPrint(out, "Usage: !dumpmoduleexports <packageAddress>\n");
			return;
		}
		try {
