 ...
 * To display all j9packages exported by the module, use !dumppackageexports 0x000001305F46DB38
...
public class J9ModuleStructureFormatter extends BaseStructureFormatter 
{
			...
			List<IFieldFormatter> fieldFormatters, String[] extraArgs) 
	{
		if (type.equalsIgnoreCase("j9module") && address != 0) {
			...
			out.println("To display all j9packages exported by the module, use !dumppackageexports "
