 ...
 *			Found 2 loaded classes in openj9.jvm	!j9module 0x000001305F471528
 */
public class DumpAllClassesInModuleCommand extends Command
{
	...
	public void run(String command, String[] args, Context context, PrintStream out) throws DDRInteractiveCommandException 
	{
		...
		try {
			...
			String matchModuleName = J9ObjectHelper.stringValue(modulePtr.moduleName());
			String moduleName = null;
			int hitCount = 0;
			PatternString pattern = new PatternString(matchModuleName);
			
			while (iterator.hasNext()) {
				classPtr = iterator.next();
				moduleName = J9ObjectHelper.stringValue(classPtr.module().moduleName());
			...
			out.printf("Found %d loaded classes in %s\t!j9module %s\n", hitCount, matchModuleName, targetModuleAddress);
