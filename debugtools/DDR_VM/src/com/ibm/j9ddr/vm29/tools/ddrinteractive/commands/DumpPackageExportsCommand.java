...
/**
 * DumpPackageExports command displays all display all j9packages exported by the target module
 * 
 * Example:
 * 			!dumppackageexports 0x00000130550C7E88
 * Example output: 
 ...
 */
public class DumpPackageExportsCommand extends Command
{

	public DumpPackageExportsCommand()
	{
		addCommand("dumppackageexports", "<targetModuleAddress>", "display all j9packages exported by the target module");
	}
	
	public void run(String command, String[] args, Context context, PrintStream out) throws DDRInteractiveCommandException 
	{
		if (args.length != 1) {
			CommandUtils.dbgPrint(out, "Usage: !dumppackageexports <targetModuleAddress>\n");
			return;
		}			
		try {
