...
public class ModuleHashTable extends HashTable_V1<J9ModulePointer>
{
	 ...
	 * @return The module hash table opened from the given j9 hash table pointer
	 */
	...
	private static class ModuleHashFn implements HashFunction<J9ModulePointer> 
	{
		...
		{
			StringHashFunction<J9ModulePointer> stringHashFn = new StringTable.StringHashFunction<J9ModulePointer>();
	...
	private static class ModuleHashEqualFn implements HashEqualFunction<J9ModulePointer> 
	{
		...
		{
			StringEqualFunction<J9ModulePointer> stringHashEqualFn = new StringEqualFunction<J9ModulePointer>();
